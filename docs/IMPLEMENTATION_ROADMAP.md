...
### 우선순위 0: Poly 스키마 렌더러 (Web)

**목표:** .poly 스키마 파일을 웹에서 시각적으로 렌더링

| 작업 | 설명 | 파일 |
|------|------|------|
| 0-1 | HTML 기본 구조 | `tools/poly-viewer/index.html` |
| 0-2 | JS 파서 및 토크나이저 | `tools/poly-viewer/poly-renderer.js` |
| 0-3 | 신택스 하이라이팅 (키워드, 타입, 주석) | `poly-renderer.js` |
| 0-4 | 어노테이션/제약조건 색상 구분 | `poly-renderer.js` |
| 0-5 | CSS 스타일링 (다크/라이트 모드) | `tools/poly-viewer/style.css` |
