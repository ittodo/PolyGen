...
REM PolyGen SQLite DDL Integration Test Runner for Windows
...
set VALIDATION_LOG=!TEST_OUTPUT!\sqlite_validation.log

echo   Generating SQLite DDL...
"!POLYGEN!" --schema-path "!SCHEMA_PATH!" --lang sqlite --output-dir "!TEST_OUTPUT!" --templates-dir "!PROJECT_ROOT!\templates" > "!GENERATION_LOG!" 2>&1
if errorlevel 1 (
...
if not exist "!TEST_OUTPUT!\sqlite\schema.sql" (
...
python "!SCRIPT_DIR!validate_sqlite.py" "!TEST_OUTPUT!\sqlite\schema.sql" > "!VALIDATION_LOG!" 2>&1
if errorlevel 1 (
