...
REM PolyGen Mermaid ER diagram Integration Test Runner for Windows
...
set VALIDATION_LOG=!TEST_OUTPUT!\mermaid_validation.log

echo   Generating Mermaid diagram...
"!POLYGEN!" --schema-path "!SCHEMA_PATH!" --lang mermaid --output-dir "!TEST_OUTPUT!" --templates-dir "!PROJECT_ROOT!\templates" > "!GENERATION_LOG!" 2>&1
if errorlevel 1 (
...
if not exist "!TEST_OUTPUT!\mermaid\schema.mmd" (
...
python "!SCRIPT_DIR!validate_mermaid.py" "!TEST_OUTPUT!\mermaid\schema.mmd" > "!VALIDATION_LOG!" 2>&1
if errorlevel 1 (
