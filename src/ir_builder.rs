...
use crate::ir_model::{
    self, EnumDef, EnumItem, FieldDef, FileDef, ForeignKeyDef, IndexDef, NamespaceDef,
    NamespaceItem, RelationDef, RenameInfo, RenameKind, SchemaContext, StructDef, StructItem,
    TypeRef,
};
